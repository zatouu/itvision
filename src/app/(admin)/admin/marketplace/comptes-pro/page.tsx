    ...
    return (
      <tr className="border-b border-stone-100 hover:bg-stone-50/50 transition-colors">
        <td className="px-4 py-3">
          <div className="font-medium text-sm text-stone-900">{user.name}</div>
        ...
        <td className="px-4 py-3 text-xs text-stone-400 text-center">
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-stone-900">Comptes Marketplace Pro</h1>
          <p className="text-sm text-stone-500 mt-1">Gerez les tiers marketplace et validez les demandes Pro.</p>
        </div>
        <Link
          href="/admin"
          className="px-4 py-2 text-sm font-semibold rounded-xl border border-stone-200 bg-white text-stone-700 hover:bg-stone-50 transition"
        >
          Retour admin
        </Link>
      </div>
        ...
        <div className="space-y-8">
            ...
            {pendingUsers.length === 0 ? (
              ...
              <div className="rounded-xl border border-stone-200 bg-white overflow-hidden shadow-sm">
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-stone-200 bg-stone-50/80 text-xs font-semibold text-stone-500 uppercase tracking-wider">
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-bold text-stone-900">
                Comptes Pro actifs
                <span className="ml-2 text-sm font-normal text-stone-400">({activeUsers.length})</span>
              </h2>
            </div>
