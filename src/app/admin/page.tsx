...
export default function AdminDashboard() {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-gradient-to-br from-gray-50 via-green-50/30 to-emerald-50/20">
      <AdminSidebar />
      <div className="flex-1 overflow-y-auto overflow-x-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10 space-y-6 lg:space-y-8 pb-20">
