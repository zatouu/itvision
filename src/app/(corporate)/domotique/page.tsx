...
export default function DomotiquePage() {
  ...
  return (
    <main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Domotique &amp; <span className="bg-gradient-to-r from-emerald-600 to-emerald-600 bg-clip-text text-transparent">Bâtiment Intelligent</span>
            </h1>
            <p className="text-xl md:text-2xl text-stone-700 dark:text-stone-300 max-w-4xl mx-auto mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {protocols.map((protocol, index) => {
              ...
              return (
                <div
                  key={protocol.id}
                  className="bg-white rounded-2xl shadow-lg border border-stone-100 overflow-hidden modern-card"
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="bg-gradient-to-r from-stone-50 to-stone-100 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-2">
                        <span className="text-sm font-medium text-stone-600">Budget:</span>
                        <span className={`text-lg font-bold ${
                          solution.budget === 'Accessible' ? 'text-emerald-600' :
                          solution.budget === 'Modulaire' ? 'text-blue-600' : 'text-orange-600'
                        }`}>{solution.budget}</span>
                      </div>
                      <p className="text-sm text-stone-600 mb-2">{solution.budgetDetail}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {applications.map((application, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl shadow-lg border border-stone-100 p-6 modern-card"
              >
      ...
      <section className="py-20 bg-gradient-to-br from-stone-800 via-stone-900 to-black text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            {[
              ...
              return (
                <div key={index} className="text-center">
                  ...
                  <p className="text-stone-300 leading-relaxed">{reason.description}</p>
                </div>
              )
            })}
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-600 via-teal-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/contact"
              className="bg-white text-emerald-600 px-8 py-4 rounded-lg font-semibold hover:bg-stone-100 transition-all duration-300 inline-flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Consultation Expert
