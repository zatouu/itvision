...
export default function AboutPage() {
  ...
  return (
    <main>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-white via-stone-50 to-emerald-50 page-content py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              À propos d&apos;<span className="bg-gradient-to-r from-emerald-600 to-emerald-600 bg-clip-text text-transparent">IT Vision</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gradient-to-br from-stone-100 to-stone-200 rounded-2xl p-8 text-center">
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-4">5+ ans d&apos;expérience</h3>
              <p className="text-stone-600">Sécurité électronique, domotique et digitalisation des PME depuis 2019</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl p-6 shadow-lg border border-stone-100 modern-card text-center">
                  <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg mx-auto mb-4">
                    <IconComponent className="h-8 w-8 text-white" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div key={index} className="bg-white rounded-2xl shadow-lg border border-stone-100 overflow-hidden modern-card">
                ...
                <div className="p-6">
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium text-stone-500">Expérience:</span>
                      <span className="text-sm font-semibold text-stone-900">{member.experience}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-stone-500 block mb-2">Spécialité:</span>
                      <span className="text-sm text-stone-900">{member.speciality}</span>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-stone-500 block mb-2">Certifications:</span>
      ...
      <section className="py-20 bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-12">
            <Link
              href="/contact"
              className="bg-white text-emerald-600 px-8 py-4 rounded-lg font-semibold hover:bg-stone-100 transition-all duration-300 inline-flex items-center shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
