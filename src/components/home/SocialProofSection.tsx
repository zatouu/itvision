      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
            {['Hikvision', 'Dahua', 'Uniview'].map((brand) => (
              <div
                key={brand}
                className="w-28 h-14 bg-slate-100 rounded-xl flex items-center justify-center text-slate-400 font-bold text-sm tracking-wide"
              >
                {brand}
              </div>
            ))}
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-bold text-slate-700">1200+ commandes livrées</span>
          </div>
          <div className="flex items-center gap-2">
            <Star className="h-5 w-5 text-emerald-500" />
            <span className="text-sm font-bold text-slate-700">4.8/5 satisfaction</span>
          </div>
          <div className="flex items-center gap-2">
            <Globe className="h-5 w-5 text-emerald-500" />
            <span className="text-sm font-bold text-slate-700">Tout le Sénégal</span>
          </div>
        </motion.div>
      </div>
    </section>
