...
export default function SourcingOnDemand({ onOpenImageSearch, onOpenSourcing }: SourcingOnDemandProps) {
  return (
    <section className="py-12 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mb-8">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 px-5 py-3 rounded-xl font-semibold transition-colors"
              >
