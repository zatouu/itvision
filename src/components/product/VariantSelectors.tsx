                  ...
                  return (
                    <button
                      ...
                      className={clsx(
                        ...
                        selected ? "border-emerald-500 ring-2 ring-emerald-100" : "border-gray-200 hover:border-emerald-300 opacity-80 hover:opacity-100"
                      )}
                      title={v.name}
                    >
                      {v.image ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-xs text-gray-500">{v.name.slice(0,2)}</div>
                      )}
                    </button>
                  )
                })}
