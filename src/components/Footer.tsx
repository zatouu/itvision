...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-stone-900 via-stone-800 to-emerald-900 text-white py-12 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-stone-300">
              ...
              <li><Link href="/services/fiber-optic" className="hover:text-emerald-400 transition-colors duration-300">Fibre Optique FTTH</Link></li>
              <li><Link href="/services/maintenance" className="hover:text-emerald-400 transition-colors duration-300">Maintenance & Support</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-emerald-800 border-opacity-30 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <Link href="/mentions-legales" className="text-stone-400 hover:text-emerald-400 text-sm transition-colors duration-300">
                Mentions légales
              </Link>
              <Link href="/politique-confidentialite" className="text-stone-400 hover:text-emerald-400 text-sm transition-colors duration-300">
                Politique de confidentialité
              </Link>
              <Link href="/cgv" className="text-stone-400 hover:text-emerald-400 text-sm transition-colors duration-300">
                CGV
              </Link>
            </div>
          </div>
