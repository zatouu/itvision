    ...
    <div className="flex items-center gap-2">
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full pl-9 pr-3 py-2.5 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-ddm-emerald/30 focus:border-ddm-emerald"
        />
      </div>
      <motion.button
        whileTap={{ scale: 0.97 }}
