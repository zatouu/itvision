...
export default function AdminHeader() {
  ...
  return (
    <header className="fixed top-0 left-64 right-0 h-16 bg-white/70 backdrop-blur border-b border-stone-200 z-40">
      <div className="h-full flex items-center justify-between px-6">
        ...
        <div className="flex-1 max-w-xl mx-6">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg border border-stone-200 text-stone-500 hover:text-stone-700 hover:border-stone-300 text-sm"
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setDark((v) => !v)}
            className="p-2 rounded-lg border border-stone-200 hover:bg-stone-100 text-stone-600"
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-24 bg-black/30">
          <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-stone-200 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="text-xs text-stone-500 mt-2">Indexation et résultats seront ajoutés ultérieurement.</div>
            </div>
          </div>
        </div>
      )}
