        ...
        <div className="p-4 flex flex-col justify-between flex-1 bg-white">
          ...
          <div className="mb-3">
            <div className="flex items-baseline gap-2">
              <span className={showQuote ? 'text-3xl font-extrabold text-gray-700' : 'text-3xl font-extrabold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent'}>
                {computedPriceLabel}
              </span>
          ...
          <div className="mt-auto pt-3 border-t border-gray-100 flex items-center gap-2">
            ...
            <a
              ...
              onClick={(e) => {
                e.stopPropagation()
                const productIdForTracking = model ? `${name}-${model}` : name
                trackEvent('quote_request', { productId: productIdForTracking })
              }}
              className={showQuote 
                ? 'inline-flex items-center justify-center gap-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white px-4 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm hover:shadow-md'
                : 'inline-flex items-center justify-center gap-1.5 bg-white border-2 border-gray-200 hover:border-emerald-400 text-gray-700 hover:bg-emerald-50 px-4 py-2.5 rounded-xl text-sm font-bold transition-all shadow-sm hover:shadow-md'
              }
            >
