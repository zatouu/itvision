...
const KIND_META: Record<Notification['kind'], { icon: string; color: string; bg: string; labelKey: string }> = {
  'offer-received':         { icon: 'O', color: '#F59E0B', bg: '#FFFBEB', labelKey: 'notifications.kind_offer' },
  'request-assigned':       { icon: 'A', color: '#10B981', bg: '#ECFDF5', labelKey: 'notifications.kind_mission' },
  'request-status-changed': { icon: 'S', color: '#8B5CF6', bg: '#F5F3FF', labelKey: 'notifications.kind_mission' },
