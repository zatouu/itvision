 ...
 * - Mode client/prestataire réinitialisé
...
export async function clearAllUserData(): Promise<void> {
  ...
  // 3. Async storage cleanup (parallèle pour rapidité)
  await Promise.all([
    cacheClearAll(),
    clearProfileStorage(),
