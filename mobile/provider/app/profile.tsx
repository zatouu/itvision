...
const s = StyleSheet.create({
  ...
  referralCard: { backgroundColor: '#E6F4EC', borderRadius: 14, padding: 18, borderWidth: 1.5, borderColor: '#A7F3D0', gap: 10 },
  referralTitle: { fontSize: 16, fontWeight: '800', color: '#065F3A' },
  referralSubtitle: { fontSize: 12, color: '#0F7B4F', lineHeight: 18 },
  referralCodeBox: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#fff', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 10, borderWidth: 1, borderColor: '#A7F3D0' },
  referralCode: { fontSize: 20, fontWeight: '800', color: '#0F172A', letterSpacing: 3, flex: 1 },
  referralShareBtn: { backgroundColor: '#0F7B4F', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 8 },
  ...
  referralStatNum: { fontSize: 15, fontWeight: '800', color: '#065F3A' },
  referralStatLabel: { fontSize: 11, color: '#0F7B4F', marginTop: 2 },
