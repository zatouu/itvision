      ...
      >
        ...
        <View style={s.balanceCard}>
          ...
          {isFree ? (
            <View style={s.freeBadge}>
              <Text style={s.freeBadgeText}>Mode gratuit — aucune mission ne consomme de XC</Text>
            </View>
          ) : (
            <View style={s.modeBadge}>
              <Text style={s.modeBadgeText}>{data?.config.pointsPerWonMission} XC par mission gagnée</Text>
            </View>
          )}
        </View>
        ...
        <View style={s.lifetimeRow}>
          ...
          <View style={s.lifetimeCard}>
            ...
            <Text style={s.lifetimeLabel}>Dépensés</Text>
          </View>
        </View>
...
const s = StyleSheet.create({
  ...
  balanceCard: { backgroundColor: '#0F172A', borderRadius: 18, padding: 24, alignItems: 'center', gap: 2 },
  balanceLabel: { color: '#94A3B8', fontSize: 13, fontWeight: '600' },
  balanceValue: { color: '#fff', fontSize: 48, fontWeight: '900', letterSpacing: -1 },
  balanceUnit: { color: '#64748B', fontSize: 14, fontWeight: '600' },
  ...
  modeBadge: { marginTop: 12, backgroundColor: '#1E3A8A', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 8 },
  modeBadgeText: { color: '#93C5FD', fontSize: 12, fontWeight: '700' },
  ...
  packActive: { backgroundColor: '#EFF6FF', borderColor: '#2563EB' },
  packNum: { fontSize: 20, fontWeight: '800', color: '#0F172A' },
  packNumActive: { color: '#2563EB' },
  packFcfa: { fontSize: 11, color: '#64748B', marginTop: 2 },
  packFcfaActive: { color: '#2563EB' },
  ...
  opActive: { backgroundColor: '#0F172A', borderColor: '#0F172A' },
  opText: { fontSize: 12, fontWeight: '700', color: '#475569' },
  opTextActive: { color: '#fff' },
  payBtn: { backgroundColor: '#2563EB', borderRadius: 12, paddingVertical: 15, alignItems: 'center' },
