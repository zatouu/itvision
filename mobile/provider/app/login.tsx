    ...
    <SafeAreaView style={s.safe}>
      <KeyboardAvoidingView style={s.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <View style={s.top}>
          ...
          <Text style={s.title}>Ligey Prestataire</Text>
          <Text style={s.subtitle}>Recevez des missions près de vous</Text>
        </View>
...
const s = StyleSheet.create({
  ...
  logoText: { fontSize: 32, fontWeight: '800', color: '#0F172A' },
  ...
  btn: { backgroundColor: '#F59E0B', borderRadius: 12, padding: 17, alignItems: 'center', marginTop: 8 },
