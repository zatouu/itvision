...
const ICON_PATHS = {
  ...
  award: [<circle cx="12" cy="8" r="7" />, "M8.21 13.89 7 23l5-3 5 3-1.21-9.12"],
  store: ["M2 7v13a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V7", "M4 4h16l1 3H3z", "M9 21v-6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v6"],
  factory: ["M2 20V13l6 3v-3l6 3V8l6 3v9z", "M2 20h20", "M17 20V6"],
  upload: ["M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4", "M17 8l-5-5-5 5", "M12 3v12"],
  fileText: ["M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z", "M14 2v6h6", "M16 13H8M16 17H8M10 9H8"],
  helpCircle: [<circle cx="12" cy="12" r="10" />, "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3", "M12 17h.01"],
  edit: ["M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7", "M18.5 2.5a2.12 2.12 0 0 1 3 3L12 15l-4 1 1-4z"],
  chartUp: ["m3 3v18h18", "M18 17V9M13 17V5M8 17v-3"],
  refresh: ["M23 4v6h-6M1 20v-6h6", "M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"],
  banknote: [<rect x="2" y="6" width="20" height="12" rx="2" />, <circle cx="12" cy="12" r="2" />, "M6 12h.01M18 12h.01"],
  building: [<rect x="4" y="2" width="16" height="20" rx="2" />, "M9 22v-4h6v4M8 6h.01M16 6h.01M12 6h.01M12 10h.01M12 14h.01M16 10h.01M16 14h.01M8 10h.01M8 14h.01"],
};
...
const PAYMENT_SUCCESS = {
  reference: "PAY-2026-9812AB",
  orderId: "CMD-0005",
  type: "order", // "order" | "group"
  amount: 195400,
  paidAt: "11 sept. 2026 · 14h32",
  method: "Wave · **** 4587",
  items: [
    { name: "Caméra IP dôme extérieure 4MP", qty: 5, image: "assets/img/product-camera.jpg" },
    { name: "Ruban LED RGB COB 5m", qty: 10, image: "assets/img/product-led.jpg" },
  ],
  eta: "18-24 sept.",
  groupId: null,
};
...
const SHOPS = {
  factory: {
    slug: "guangzhou-vision-tech",
    name: "Guangzhou Vision Tech",
    type: "factory", // "factory" (usine chinoise) | "partner" (partenaire local)
    verified: true,
    rating: 4.8,
    reviewCount: 342,
    yearsActive: 8,
    location: "Guangzhou, Chine",
    coverGradient: "from-violet-700 via-violet-600 to-emerald-600",
    initials: "GV",
    description: "Fabricant spécialisé caméras IP et systèmes de vidéosurveillance depuis 2018. Inspecté et audité par DDM+ trimestriellement.",
    categories: ["Sécurité", "Réseau"],
    productCount: 42,
    responseTime: "< 2h",
    onTimeRate: 96,
    products: CATALOG.filter(p => p.cat === "Sécurité" || p.cat === "Éclairage").slice(0, 8),
    reviews: [
      { initials: "CA", handle: "Client A", rating: 5, date: "05 sept.", text: "Livraison conforme, packaging impeccable. On refera affaire." },
      { initials: "CB", handle: "Client B", rating: 5, date: "28 août",  text: "Négociation directe simplifiée par DDM+. Produits testés à réception." },
      { initials: "CC", handle: "Client C", rating: 4, date: "14 août",  text: "Petit retard sur le transport mais qualité au rendez-vous." },
    ],
  },
  partner: {
    slug: "atelier-dakar-mode",
    name: "Atelier Dakar Mode",
    type: "partner",
    verified: true,
    rating: 4.6,
    reviewCount: 87,
    ...
    coverGradient: "from-emerald-600 via-emerald-500 to-amber-500",
    initials: "AD",
    description: "Revendeur partenaire spécialisé mode et accessoires. Stock à Dakar, livraison 24-48h.",
    categories: ["Mode", "Beauté"],
    productCount: 28,
    responseTime: "< 30min",
    onTimeRate: 98,
    products: CATALOG.filter(p => p.cat === "Mode" || p.cat === "Beauté" || p.cat === "Audio").slice(0, 8),
    reviews: [],
  },
};

// Sourcing request tracking
const SOURCING_REQUESTS = {
  proposal_ready: {
    token: "SRC-2026-A7F3B1",
    status: "proposal_ready",
    createdAt: "09 sept. · 10:42",
    request: {
      photo: "assets/img/product-camera.jpg",
      description: "Caméra intérieure 360° avec vision nocturne, compatible Alexa",
      targetQty: 15,
      budgetMax: 22000,
      deadline: "Avant fin octobre",
    },
    proposal: {
      productName: "Caméra IP 360° 4MP · Vision nocturne · WiFi + Alexa",
      supplier: "Shenzhen Smart Home Co.",
      supplierVerified: true,
      unitPrice: 18500,
      totalPrice: 277500,
      marketPrice: 26000,
      savingPct: 29,
      shipping: "Aérien standard · 8-12j",
      warranty: "12 mois",
      moq: 15,
      notes: "Compatible protocole ONVIF, application dédiée iOS/Android, stockage cloud 7j inclus.",
      image: "assets/img/product-camera.jpg",
      sentAt: "10 sept. · 15:20",
    },
  },
  searching: {
    token: "SRC-2026-C2E8D4",
    status: "searching",
    createdAt: "10 sept. · 09:15",
    request: {
      photo: "assets/img/product-earbuds.jpg",
      description: "Écouteurs enfants sans fil ANC, coques colorées",
      targetQty: 30,
      budgetMax: 8000,
      deadline: "Avant fin novembre",
    },
    proposal: null,
    slaHours: 24,
  },
...
const SOURCING_STEPS = [
  { key: "received", label: "Demande reçue",         desc: "Notre équipe a bien reçu votre demande" },
  { key: "searching", label: "Recherche en cours",   desc: "Consultation des fournisseurs en Chine" },
  { key: "proposal", label: "Proposition disponible",desc: "Devis prêt à être examiné" },
  { key: "ordering", label: "En commande",           desc: "Fabrication et inspection qualité" },
  { key: "delivered", label: "Livré",                desc: "Reçu à l'adresse indiquée" },
];
...
const VENDOR = {
  ...
  products: [
    { id: "vp1", name: "Sac cabas cuir synthétique", price: 9200, stock: 12, image: "assets/img/product-bag.jpg", cat: "Mode" },
    { id: "vp2", name: "Écouteurs sans fil TWS Pro", price: 8900, stock: 3, image: "assets/img/product-earbuds.jpg", cat: "Audio", lowStock: true },
    { id: "vp3", name: "Montre connectée fitness IP68", price: 12500, stock: 18, image: "assets/img/product-watch.jpg", cat: "Objets connectés" },
    { id: "vp4", name: "Support MagSafe voiture 15W", price: 6800, stock: 2, image: "assets/img/product-carmount.jpg", cat: "Auto", lowStock: true },
    { id: "vp5", name: "Ruban LED RGB COB 5m", price: 4200, stock: 25, image: "assets/img/product-led.jpg", cat: "Éclairage" },
  ],
  orders: [
    { id: "CMD-0101", client: "Client A", date: "10 sept.", status: "pending", total: 42600, itemCount: 2 },
    { id: "CMD-0102", client: "Client B", date: "09 sept.", status: "shipped", total: 18400, itemCount: 1 },
    { id: "CMD-0103", client: "Client C", date: "07 sept.", status: "delivered", total: 74800, itemCount: 4 },
  ],
};
...
const PAYMENT_METHODS = [
  { key: "wave",   label: "Wave",           sub: "Instant · Sans frais",       merchantPhone: "+221 78 000 00 00", tone: "blue",   accentBg: "bg-[#00B0F0]", initials: "W" },
  { key: "om",     label: "Orange Money",   sub: "Instant · Frais standards",  merchantPhone: "+221 77 111 11 11", tone: "amber",  accentBg: "bg-[#FF6600]", initials: "OM" },
  { key: "free",   label: "Free Money",     sub: "Instant · Frais standards",  merchantPhone: "+221 76 222 22 22", tone: "violet", accentBg: "bg-[#CD0067]", initials: "F" },
  { key: "wire",   label: "Virement bancaire", sub: "24-48h · Pour gros volumes", iban: "SN12 0001 2345 6789 0123 4567 890", tone: "slate", accentBg: "bg-slate-700", initials: "VB" },
];

// Order detail (extension d'ORDERS[0])
const ORDER_DETAIL = {
  id: "CMD-0001",
  date: "2026-09-08",
  status: "in_transit",
  ...
  eta: "12-15 sept.",
  items: [
    { name: "Caméra IP dôme extérieure 4MP", variant: "4MP · IR 30m", qty: 20, unit: 16500, image: "assets/img/product-camera.jpg" },
    { name: "Câble Ethernet Cat6 20m", variant: "Cat6 · 20m", qty: 25, unit: 3200, image: "assets/img/product-led.jpg" },
  ],
  breakdown: {
    subtotal: 410000,
    service: 16400,
  ...
  address: {
    ...
    line1: "Route de Ngor, Résidence Les Almadies",
    line2: "Villa 12",
    city: "Almadies, Dakar",
    region: "Dakar",
  },
  carrier: {
    ...
    lastUpdate: "10 sept. · 14h22",
  },
  chatMessages: [
    { from: "support", initials: "DDM", name: "DDM+ Support", text: "Bonjour, votre commande est arrivée à l'inspection qualité en Chine. Les 20 caméras sont conformes.", time: "10:15" },
    { from: "user", initials: "CA", name: "Client A", text: "Parfait ! Quel est le délai prévu pour l'arrivée ?", time: "10:32" },
    { from: "support", initials: "DDM", name: "DDM+ Support", text: "Départ Guangzhou aujourd'hui, arrivée Dakar entre le 12 et 15 septembre.", time: "10:35" },
  ],
};

// Order-specific dispute/return context (pré-rempli pour /suivi/[ref]/litige)
const CLAIM_CONTEXT = {
  reference: "CMD-0001",
  itemsAvailable: ORDER_DETAIL.items,
  totalPaid: ORDER_DETAIL.breakdown.total,
};
...
Object.assign(window, {
  ...
  PAYMENT_SUCCESS, SHOPS, SOURCING_REQUESTS, SOURCING_STEPS, VENDOR,
  PAYMENT_METHODS, ORDER_DETAIL, CLAIM_CONTEXT,
});
