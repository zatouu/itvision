...
const SCREENS = [
  ...
  { key: "paymentCheckout", label: "Paiement checkout", icon: "wallet", comp: "ScreenPaymentCheckout", batch: 4 },
  { key: "paymentCancel", label: "Paiement annulé", icon: "x", comp: "ScreenPaymentCancel", batch: 4 },
  { key: "orderDetail", label: "Détail commande", icon: "fileText", comp: "ScreenOrderDetail", batch: 4 },
  { key: "claimRetour", label: "Retour produit", icon: "refresh", comp: "ScreenClaimRetour", batch: 4 },
  { key: "claimLitige", label: "Litige commande", icon: "info", comp: "ScreenClaimLitige", batch: 4 },
  { key: "claimReclamation", label: "Réclamer commande", icon: "helpCircle", comp: "ScreenClaimReclamation", batch: 4 },
];
      ...
      <aside className="hidden md:flex sticky top-0 h-screen w-60 flex-shrink-0 flex-col border-r border-neutral-300/50 bg-white dark:border-neutral-800 dark:bg-neutral-950">
        ...
        <div className="flex-1 overflow-y-auto p-3">
          {[1,2,3,4].map((batch) => {
            ...
            const batchLabels = {1: "Batch 1 · Parcours", 2: "Batch 2 · Achat", 3: "Batch 3 · Finalisation", 4: "Batch 4 · Post-achat"};
            return (
