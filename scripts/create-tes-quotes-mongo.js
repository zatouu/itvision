// Devis TES à insérer dans MongoDB
// Exécuter avec: docker exec -it itvision-mongodb mongosh "mongodb://itvision_app:ITVDB2025@localhost:27017/itvision_db?authSource=admin" --eval "$(cat create-tes-quotes-mongo.js)"
...
const result = db.adminquotes.insertMany(quotes);
print("✓ Devis créés avec succès:");
print("  - Devis Serrure Antalya (2026-0011-SERRURE): 287,999 CFA");
print("  - Devis Interphone SHIRAMBA (2026-0011-INTERPHONE): 1,792,000 CFA (Total 7 immeubles: 12,544,000 CFA)");
